...
import KioskPostEditorComponent from '@/pages/dashboard/kiosk-post/component/KioskPostEditorComponent.vue'
import KioskPostFileComponent from '@/pages/dashboard/kiosk-post/component/KioskPostFileComponent.vue'
...
function submitForm() {
  formRef.value
    ...
    .then(() => {
      if (route.params.id) {
        kioskPostPinia.updatePost(route.params.id, form, () => {
          router.back()
        })
      } else {
        kioskPostPinia.createNewPost(form, () => {
          router.back()
        })
      }
    })
      ...
      <a-form ref="formRef" layout="vertical" :model="form" :rules="rules">
        ...
        <div class="flex justify-end">
          <a-space>
            ...
            <a-button
              :loading="loadingUrl.has('create/kiosk-post')"
              @click="submitForm"
              type="primary"
            >
              {{ $t('SAVE') }} 
