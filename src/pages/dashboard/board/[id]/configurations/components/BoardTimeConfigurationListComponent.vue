...
import BoardTimeConfigurationItemComponent from '@/pages/dashboard/board/[id]/configurations/components/BoardTimeConfigurationItemComponent.vue'
...
<template>
  ...
  >
    <template #content>
      ...
      <board-time-configuration-item-component
        class="my-2"
