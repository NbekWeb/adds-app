...
import OrderBoardSelectComponent from '@/pages/dashboard/order/telegram-order/components/order-form/OrderBoardSelectComponent.vue'
import OrderConfigurationSelectComponent from '@/pages/dashboard/order/telegram-order/components/order-form/OrderConfigurationSelectComponent.vue'
import OrderTimeConfigSelectComponent from '@/pages/dashboard/order/telegram-order/components/order-form/OrderTimeConfigSelectComponent.vue'
