...
import OrderBoardConfigurationComponent from '@/pages/dashboard/order/telegram-order/components/order-form/OrderBoardConfigurationComponent.vue'
import { storeToRefs } from 'pinia'
import useCore from '@/store/core.pinia.js'
import ScrollbarComponent from '@/components/ScrollbarComponent.vue'
import OrderBoardDefaultConfigurationComponent from '@/pages/dashboard/order/telegram-order/components/order-form/OrderBoardDefaultConfigurationComponent.vue'
