...
import ViewsComponent from '@/pages/dashboard/order/kiosk-order/[id]/components/ViewsComponent.vue'
import WarningComponent from '@/pages/dashboard/order/kiosk-order/[id]/components/WarningComponent.vue'
