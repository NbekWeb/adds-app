...
import ViewsComponent from '@/pages/dashboard/order/kiosk/[id]/components/ViewsComponent.vue'
import WarningComponent from '@/pages/dashboard/order/kiosk/[id]/components/WarningComponent.vue'
...
function cancelOrder() {
  ...
  router.push({ name: 'DashboardOrderListView', query: { channel: 'kiosk' } })
}
</script>
